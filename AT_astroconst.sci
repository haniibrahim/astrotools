function AT_astroconst(silence)
    ...
    "o_dist", 1.49598e+08, .. // Semimajor axis - mean distance from sun (m)
    ...
    "o_day_sid", 23.9345, .. // Sidereal rotation period (h)
    "o_day_sol", 24.0000, .. // Length of day (h)
...
//    );
    ...
    "o_dist", 3.84400e+05, .. // Semimajor axis - mean distance from sun (m)
    ...
    "o_day_sid", 655.7200, .. // Sidereal rotation period (h)
    "o_day_sol", 708.7200, .. // Length of day (h)
    ...
    "o_dist", 5.79090e+07, .. // Semimajor axis - mean distance from sun (m)
    ...
    "o_day_sid", 1407.6000, .. // Sidereal rotation period (h)
    "o_day_sol", 4222.6000, .. // Length of day (h)
    ...
    "o_dist", 1.08210e+08, .. // Semimajor axis - mean distance from sun (m)
    ...
    "o_day_sid", -5832.6000, .. // Sidereal rotation period (h)
    "o_day_sol", 2802.0000, .. // Length of day (h)
    ...
    "o_dist", 2.27956e+08, .. // Semimajor axis - mean distance from sun (m)
    ...
    "o_dist", 7.78479e+08, .. // Semimajor axis - mean distance from sun (m)
    ...
    "o_dist", 1.43204e+09, .. // Semimajor axis - mean distance from sun (m)
    ...
    "o_dist", 2.86704e+09, .. // Semimajor axis - mean distance from sun (m)
    ...
    "o_dist", 4.51495e+09, .. // Semimajor axis - mean distance from sun (m)
